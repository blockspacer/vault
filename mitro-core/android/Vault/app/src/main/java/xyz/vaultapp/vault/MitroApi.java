...
import xyz.vaultapp.api.RPC;
import xyz.vaultapp.api.RPC.ListMySecretsAndGroupKeysResponse.GroupInfo;
import xyz.vaultapp.api.RPC.ListMySecretsAndGroupKeysResponse.SecretToPath;
...
public class MitroApi {
  ...
  private static final String API_BASE_PATH = "https://api.vaultapp.xyz/mitro-core/api/";
