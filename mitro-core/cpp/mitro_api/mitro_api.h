...
namespace mitro_api {
  ...
  typedef base::Callback<void(MitroApiError*)> AddSecretCallback;
  ...
  public:
    ...
    void AddSecretPassword(const std::string& title,
                           const std::string& login_url,
                           const std::string& username,
                           const std::string& password,
                           const AddSecretCallback& callback);

    void AddSecretNote(const std::string& title,
  ...
  private:
    ...
    void SignAndPostRequest(const std::string& endpoint,
    ...
    void AddSecretCommon(const SecretClientData& client_data,
                         const SecretCriticalData& critical_data,
                         const AddSecretCallback& callback);

    void OnAddSecret(const AddSecretCallback& callback,
                     const net::HttpResponse& response);

    void SetUserGroupIdAndKeyFromSecretsListResponse(
    ...
    base::scoped_ptr<mitro::MitroPrivateKey> user_group_private_key_;
